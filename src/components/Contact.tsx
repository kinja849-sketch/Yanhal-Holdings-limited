      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <div className="space-y-4 sm:space-y-5">
            {/* Headquarters Card - Clickable Google Maps Link */}
            <a 
              href="https://www.google.com/maps/search/?api=1&query=South+C,+Behind+Masjid+As+Salaam,+Nairobi,+Kenya" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="group flex items-start gap-4 sm:gap-5 bg-[#181514]/75 hover:bg-[#221D1A]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E0B9A0] backdrop-blur-md p-4 sm:p-5 rounded-xl border border-white/15 hover:border-[#E0B9A0]/70 shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer block"
              aria-label="Visit Yanhal Holdings headquarters on Google Maps (South C, Behind Masjid As Salaam, Nairobi)"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 border border-[#E0B9A0]/40 bg-[#E0B9A0]/10 rounded-lg flex items-center justify-center text-[#E0B9A0] shrink-0 shadow-[0_0_12px_rgba(224,185,160,0.2)] group-hover:scale-110 group-hover:border-[#E0B9A0] transition-all duration-300">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-[#E0B9A0] opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
                    Map <span className="material-symbols-outlined text-xs">arrow_outward</span>
                  </span>
                </div>
                <p className="text-stone-300 text-xs sm:text-sm group-hover:text-white transition-colors leading-relaxed">
                  South C, Behind Masjid As Salaam, Nairobi
                </p>
              </div>
            </a>
            ...
            <a 
              href="tel:0724093256" 
              className="group flex items-start gap-4 sm:gap-5 bg-[#181514]/75 hover:bg-[#221D1A]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E0B9A0] backdrop-blur-md p-4 sm:p-5 rounded-xl border border-white/15 hover:border-[#E0B9A0]/70 shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer block"
              aria-label="Call primary telephone line 0724093256"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 border border-[#E0B9A0]/40 bg-[#E0B9A0]/10 rounded-lg flex items-center justify-center text-[#E0B9A0] shrink-0 shadow-[0_0_12px_rgba(224,185,160,0.2)] group-hover:scale-110 group-hover:border-[#E0B9A0] transition-all duration-300">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-[#E0B9A0] opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
                    Call <span className="material-symbols-outlined text-xs">call_made</span>
                  </span>
                </div>
                <p className="text-stone-300 text-xs sm:text-sm group-hover:text-white transition-colors">
                  0724093256
                </p>
              </div>
            </a>

            {/* Direct WhatsApp / Secondary Line */}
            <a 
              href="https://wa.me/254740895374" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="group flex items-start gap-4 sm:gap-5 bg-[#181514]/75 hover:bg-[#221D1A]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E0B9A0] backdrop-blur-md p-4 sm:p-5 rounded-xl border border-white/15 hover:border-[#AE917E]/70 shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer block"
              aria-label="Chat on WhatsApp with Yanhal Holdings +254 740 895374"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 border border-[#AE917E]/40 bg-[#AE917E]/10 rounded-lg flex items-center justify-center text-[#AE917E] shrink-0 shadow-[0_0_12px_rgba(174,145,126,0.2)] group-hover:scale-110 group-hover:border-[#AE917E] transition-all duration-300">
                <span className="material-symbols-outlined text-xl">chat</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <h4 className="text-white font-display text-[9px] sm:text-[10px] tracking-[0.2em] uppercase mb-1 leading-none font-bold">WhatsApp &amp; Secondary Line</h4>
                  <span className="text-[10px] font-mono text-[#AE917E] opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
                    WhatsApp <span className="material-symbols-outlined text-xs">arrow_outward</span>
                  </span>
                </div>
                <p className="text-stone-300 text-xs sm:text-sm group-hover:text-white transition-colors">
                  +254 740 895374
            ...
            {/* Email Inquiries - Direct mailto Link */}
            <a 
              href="mailto:Yanhalholdingslimited@gmail.com" 
              className="group flex items-start gap-4 sm:gap-5 bg-[#181514]/75 hover:bg-[#221D1A]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E0B9A0] backdrop-blur-md p-4 sm:p-5 rounded-xl border border-white/15 hover:border-[#E0B9A0]/70 shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer block"
              aria-label="Send email inquiry to Yanhalholdingslimited@gmail.com"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 border border-[#E0B9A0]/40 bg-[#E0B9A0]/10 rounded-lg flex items-center justify-center text-[#E0B9A0] shrink-0 shadow-[0_0_12px_rgba(224,185,160,0.2)] group-hover:scale-110 group-hover:border-[#E0B9A0] transition-all duration-300">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-[#E0B9A0] opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
                    Mail <span className="material-symbols-outlined text-xs">arrow_outward</span>
                  </span>
                </div>
                <p className="text-stone-300 text-xs sm:text-sm break-all group-hover:text-white transition-colors">
                  Yanhalholdingslimited@gmail.com
                </p>
              </div>
            </a>
          </div>
